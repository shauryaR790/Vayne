    ...
    .map((n) => {
      ...
      return {
        ...
        data: {
          ...
          dimmed: wide ? false : highlightIds ? !highlightIds.has(n.id) : false,
          onPath,
        },
      };
    });
...
function GraphExplorerInner({
  ...
  const { flowNodes, flowEdges } = useMemo(
    () => buildFlowGraph(filteredNodes, filteredEdges, highlightIds, isWorkstation),
    [filteredNodes, filteredEdges, highlightIds, isWorkstation],
  );
  ...
  }, [graph.nodes, highlightIds, isWorkstation]);

  useGraphAnimations(containerRef, isWorkstation ? false : flowReady, flowNodes.length, {
    hero: isWide && !isWorkstation,
  });
  ...
  }, [flowNodes, flowReady, scrollableEmbed, isWorkstation]);
            ...
            <>
              ...
              <div className="absolute inset-0 z-[2]">
                <ReactFlow
                  ...
                  minZoom={isWorkstation ? 0.25 : 0.35}
                  maxZoom={2.5}
                  panOnDrag
                  panOnScroll={false}
                  zoomOnScroll={false}
