 ...
 *   product/frontend/styles/theme.css
 *
 * Use Tailwind classes in components: bg-vx-app, bg-vx-panel, text-vx-secondary, etc.
 */
export const THEME_FILE = "product/frontend/styles/theme.css";
